...
import kotlinx.android.synthetic.main.fragment_inword_stock_trader.*
import javax.inject.Inject

@AndroidEntryPoint
class InwordStockTraderFrag : Fragment() {
    @Inject
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_inword_stock_trader, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        inWardStockAdapter.apply {
            onItemClick {
                startActivityForResult(Intent(requireActivity(), InwardStockDetailActivity::class.java).putExtra("inwardStock", it.json()),UPDATE_INWARD_CALLBACK)
            }
        }
